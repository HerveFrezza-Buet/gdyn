...
namespace cheese_maze {
  ...
  // HFB : Je ne m'occupe pas du générateur dans les params.
  ...
  static std::string to_string (const Dir& d ) {
    ...
    case Dir::Up:
      return "U";
    default:
      return "D"; // HFB: d ne peut pas être autre chose... mais bon, en cas de bug, ton truc est peut-être mieux.
    }
  }
  ...
  class Environment { // HFB vu le namespace, on sait que c'est un cheese_maze, et j'aimais pas le nom state, confusant avec state_type.
